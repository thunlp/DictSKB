...
# parser.add_argument('--generate_type', type=str, default='dict')
# args = parser.parse_args()
# generate_type = args.generate_type
# assert generate_type in ['hownet', 'dict', 'baseline', 'tyc']
# if generate_type == 'hownet':
#     file_path = 'word_candidates_sense_hownet.pkl'
# if generate_type == 'dict':
#     file_path = 'word_candidates_sense.pkl'
# if generate_type == 'baseline':
#     file_path = 'word_candidates_sense_baseline.pkl'
# if generate_type == 'tyc':
#     file_path = 'word_cands_tyc.pkl'
file_path = 'word_candidates_sense.pkl'
np.random.seed(1111)
...
for i in range(SAMPLE_SIZE):
    ...
    if (len(test_list) + 1) % 100 == 0:
        ...
        with open('AD_dpso_sem_' + '.pkl', 'wb') as f:
            pickle.dump((attack_success_list, fail_list, adv_orig_label, adv_orig, adv_list, dist_list), f)
