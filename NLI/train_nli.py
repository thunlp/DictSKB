...
hownet_dir = 'dataset/dict_sememes.txt'
#用来将每个词还原到原型
...
if params.encoder_type not in ['LSTM_baseline', 'BILSTM_baseline', 'GRU_baseline', 'BIGRU_baseline']:
    nli_net.encoder.emb_sememe.weight.data.copy_(emb_s)
print(nli_net)
...
params.outputmodelname = params.outputmodelname + '_' + params.encoder_type + '_' + str(random_seed)
